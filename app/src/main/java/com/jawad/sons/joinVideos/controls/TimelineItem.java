...
package com.jawad.sons.joinVideos.controls;
...
import com.jawad.sons.joinVideos.Format;
import com.jawad.sons.joinVideos.R;
...
public class TimelineItem extends RelativeLayout implements View.OnClickListener, RangeSelector.RangeSelectorEvents {
    ...
    public String getVideoEffectName(int index) {
        ...
        switch (index) {
            case 0:
                return baseName + "sepia";
            case 1:
                return baseName + "grayscale";
            case 2:
                return baseName + "inverse";
            case 3:
                return baseName + "text_overlay";
            default:
